...
variable "hub" { type = bool default = true }
...
variable "enable_access_logs" { type = bool default = false }
variable "access_logs_bucket_name" { type = string default = "" }

variable "ssl_policy" { type = string default = "ELBSecurityPolicy-TLS13-1-2-2021-06" }
variable "certificate_arn" { type = string }
variable "load_balancing_algo" { type = string default = "least_outstanding_requests"}

variable "health_path" { type = string default = "/health" }
variable "healthy_threshold" { type = number default = 3 }
